...
<div class="col">
  <div class="col-md-12">
    <a href="?page=peminjaman_tambah" target="_blank" class="btn btn-primary"><i class="fa fa-plus"></i>Tambah Peminjam</a>
    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
      ...
      <tr>
        ...
        <td>
          ...
          <a onclick="return confirm('Apakah yakin akan menghapus data ini?');" href="?page=peminjaman_hapus&id=<?php echo $data['id_peminjaman']; ?>" class="btn btn-danger">Hapus</a>
        </td>
      </tr>
      <?php
